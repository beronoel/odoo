...
class AccountInvoice(models.Model):
    ...
    def invoice_line_move_line_get(self):
        ...
        for line in self.invoice_line_ids:
            ...
            analytic_tag_ids = [(4, analytic_tag.id, None) for analytic_tag in line.invoice_line_analytic_tag_ids]
...
class AccountInvoiceLine(models.Model):
    ...
    invoice_line_analytic_tag_ids = fields.Many2many('account.analytic.tag', string='Analytic tags')
