...
class SaleOrderLine(models.Model):
    ...
    @api.depends('invoice_lines.invoice_id.state', 'invoice_lines.invoice_id.invoice_refund_ids.state')
    def _compute_invoice_amount(self):
        for line in self:
            ...
            for invoice_line in line.invoice_lines:
                ...
                refund_amount_total += sum(invoice_line.invoice_id.invoice_refund_ids.filtered(lambda x: x.state in ['open', 'paid']).mapped('amount_total'))
