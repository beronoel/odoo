...
class StockConfigSettings(models.TransientModel):
    ...
    group_stock_multiple_locations = fields.Selection([
        ...
        (1, 'Manage several locations per warehouse')], string="Multi Locations",
    ...
    group_stock_adv_location = fields.Selection([
        ...
        (1, 'Advanced routing of products using rules')], string="Routes",
    ...
    def onchange_adv_location(self):
        if self.group_stock_adv_location:
            self.group_stock_multiple_locations = 1
