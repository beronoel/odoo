...
class TestMrpCommon(common2.TestStockCommon):
    ...
    def setUpClass(cls):
        ...
        (cls.product_1 | cls.product_2 | cls.product_3 | cls.product_4 | cls.product_4).write({
            'type': 'product',
        })
        ...
        cls.bom_1 = cls.env['mrp.bom'].create({
            ...
            'bom_line_ids': [
                ...
                (0, 0, {'product_id': cls.product_3.id, 'product_qty': 2})
            ]})
        cls.bom_2 = cls.env['mrp.bom'].create({
            ...
            'type': 'phantom',
            'bom_line_ids': [
                (0, 0, {'product_id': cls.product_4.id, 'product_qty': 6}),
                (0, 0, {'product_id': cls.product_5.id, 'product_qty': 3})
            ]})
