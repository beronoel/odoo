...
class account_invoice(osv.Model):
    ...
    def invoice_validate_send_email(self, cr, uid, ids, context=None):
        ...
        for invoice in self.browse(cr, uid, ids, context=context):
            ...
            if invoice.partner_id not in invoice.message_follower_ids.mapped('partner_id'):
                self.message_subscribe(cr, uid, [invoice.id], partner_ids=[invoice.partner_id.id], context=context)
