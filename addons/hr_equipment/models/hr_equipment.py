...
class HrEquipment(models.Model):
    ...
    qualification_ids = fields.Many2many(comodel_name='membership.qualification', relation='equipment_qualification', column1='qualification_id', column2='equipment_id', string='Qualifications', copy=False)
