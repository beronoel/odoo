...
tour.register('project_tour', {
    ...
    run: function (actions) {
        actions.auto();
        actions.click(".modal:visible .btn.btn-primary");
    },
}, {
    ...
    position: 'right',
    run: function (actions) {
        actions.click(this.$anchor.find(".o_project_kanban_box:first > a"));
    },
}, {
    ...
    position: "bottom",
    run: function (actions) {
        actions.click(".o_kanban_record .oe_kanban_action[data-type=edit]");
    },
}, {
    ...
    position: "bottom",
    run: function (actions) {
        actions.auto(this.$anchor.find("input"));
    },
}, {
