...
class project_configuration(osv.osv_memory):
    ...
    _columns = {
        ...
        'timesheets_apps': fields.selection([
            (0, "Do not install the Chrome app for timesheets"),
            (1, "Install the Chrome app for timesheets"),
            ], "Timesheets Apps"),
        'forecasts': fields.selection([
            (0, "Disable forecasts"),
            (1, "Enable forecasts"),
            ], "Forecasts"),
        'gantt_charts': fields.selection([
